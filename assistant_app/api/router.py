...
from assistant_app.api.routes.director_audio import router as director_audio_router
...
api_router.include_router(director_audio_router, prefix="/director", tags=["director"])
